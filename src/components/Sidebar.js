                                ...
                                <div className="w-screen max-w-md">
                                    <div className="h-full flex flex-col bg-white shadow-xl overflow-y-scroll">
                                        ...
                                        <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                                            ...
                                            <div className="mt-6">
                                                <a href="javascript:void(0)" className="flex justify-center items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">Checkout</a>
                                            </div>
